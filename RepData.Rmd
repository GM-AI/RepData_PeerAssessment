...
print(plt)
```
On weekend activity starts later (need to get that sweet morningsleep) and it is less intensive than on weekdays. Middle of the day on weekends is more active. 
